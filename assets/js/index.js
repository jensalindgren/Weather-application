...
function fetchAndUpdateWeatherData(city, temperatureUnit, windSpeedUnit) {
...
search.addEventListener('click', () => {
    ...
    fetchAndUpdateWeatherData(city, temperatureUnit, windSpeedUnit);
...
// Function to update weather data when unit options change
